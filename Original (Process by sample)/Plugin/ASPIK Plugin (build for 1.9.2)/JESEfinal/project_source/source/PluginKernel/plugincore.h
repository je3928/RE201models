...
//#include "RE201models/RE201model1.h"
//#include "RE201models/RE201model2.h"
//#include "RE201models/RE201model3.h"
#include "RE201models/RE201model4.h"
...
public:
	...
	//RE201model1 tapemodel;
	//RE201model2 tapemodel;
	//RE201model3 tapemodel;
	std::unique_ptr<RE201model4> tapemodel = nullptr;
...
private:
	...
	int solverorder = 0;
	enum class solverorderEnum { Second,Fourth };	// to compare: if(compareEnumToInt(solverorderEnum::Second, solverorder)) etc... 

	int osAmount = 0;
	enum class osAmountEnum { Two,Four,Six,Eight };	// to compare: if(compareEnumToInt(osAmountEnum::Two, osAmount)) etc... 
