...
private:
	...
	float fs = 0.0f;
	float T = 0.0f; // sample interval
	float M_s = 1.f; // Jiles book
	float a = M_s / 4.f; //adjustable parameter
	float alpha = 1.6e-3;
	float k = 0.47875; //Coercivity
	float c = 1.7e-1; //1.867e-1

	float g = 6.f; // Head gap
	float wireN = 100.f; // turns of wire
